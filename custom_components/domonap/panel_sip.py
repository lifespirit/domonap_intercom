...
class RubetekPanelSipCall(DomonapSipCall):
    ...
    The shared client owns registration and teardown. This subclass adds the
    panel-specific answer/ACK/BYE dialog and optional Asterisk SDP pass-through.
    It never proxies RTP itself.
